import svgPaths from "./svg-unya4v9kac";
import imgLogo from "./83faf8fd8d2b291d7ca269bfcc66bc1320fdc2ef.png";
...
import imgLogo4 from "./245c27076482eb05ea57ac235c0030d2e05d5feb.png";
import imgLogo5 from "./5aa69675d23e54eb737ac10d757550f5029dcce7.png";
import imgLogo6 from "./8f187b8fdecb58c0cb0c0c4e59d6149852866dd0.png";
import imgLogo7 from "./b6622fef901349d7ab872e53beefd7bacf2c0ffc.png";
import imgLogo8 from "./ee6702d5578d52155109e76f5297de96cfdea636.png";
import imgLogo9 from "./47892ad6e123a48c8ace0db3f370f2679f254b4a.png";
import imgLogo10 from "./e657ca27e8be879fbbf01a88a42db75a821a8c1d.png";
import imgLogo11 from "./3ec6890de39c4219f42cf181a86202a5c7375c6b.png";
import imgLogo12 from "./373bf2d1b8b263d028301a018a45be525edce452.png";
import imgLogo13 from "./b713cbf5a4b86b13fe91c3bbb5a9450f48c7542d.png";
import imgLogo14 from "./7c16af0cb2df19105a96db390a7f9a30bcabaa55.png";
import imgLogo15 from "./488e42354456655c278d6a328e6ee463b222c634.png";
    ...
    <div className="absolute left-[300px] size-[40px] top-[35px]" data-name="Lens">
      <svg className="absolute block inset-0 size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 40 40">
        <g id="Lens">
          ...
          <g filter="url(#filter0_f_2_1474)" id="Ellipse 3">
            <ellipse cx="20.0009" cy="10.9091" fill="var(--fill-0, white)" fillOpacity="0.1" rx="9.09091" ry="3.63636" />
          </g>
          <g filter="url(#filter1_f_2_1474)" id="Ellipse 4">
            <ellipse cx="20.0009" cy="27.2727" fill="var(--fill-0, white)" fillOpacity="0.1" rx="9.09091" ry="5.45455" />
          </g>
        </g>
        <defs>
          <filter colorInterpolationFilters="sRGB" filterUnits="userSpaceOnUse" height="9.27273" id="filter0_f_2_1474" width="20.1818" x="9.91003" y="6.27274">
            <feFlood floodOpacity="0" result="BackgroundImageFix" />
            <feBlend in="SourceGraphic" in2="BackgroundImageFix" mode="normal" result="shape" />
            <feGaussianBlur result="effect1_foregroundBlur_2_1474" stdDeviation="0.5" />
          </filter>
          <filter colorInterpolationFilters="sRGB" filterUnits="userSpaceOnUse" height="12.9091" id="filter1_f_2_1474" width="20.1818" x="9.91003" y="20.8182">
            <feFlood floodOpacity="0" result="BackgroundImageFix" />
            <feBlend in="SourceGraphic" in2="BackgroundImageFix" mode="normal" result="shape" />
            <feGaussianBlur result="effect1_foregroundBlur_2_1474" stdDeviation="0.5" />
          </filter>
  ...
  return (
    <div className="content-stretch flex gap-[56px] items-start px-[55.209px] relative shrink-0" data-name="Row">
      <div className="content-stretch flex flex-col items-start relative shrink-0" data-name="BOTTOM APP ICONS">
        <div className="content-stretch flex flex-col gap-[11.042px] items-center relative shrink-0 size-[176.67px]" data-name="habib app">
          <Logo />
        </div>
      </div>
  ...
  return (
    <div className="absolute h-[38.106px] left-[5.52px] top-[11.04px] w-[52.763px]" data-name="wifi F17">
      <svg className="absolute block inset-0 size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 52.7633 38.106">
        <g clipPath="url(#clip0_2_1484)" id="wifi F17">
  ...
  return (
    <div className="absolute h-[38.522px] left-[8.28px] top-[11.04px] w-[85.154px]" data-name="battery.100 F22 Fina">
      <svg className="absolute block inset-0 size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 85.1543 38.5217">
        <g clipPath="url(#clip0_2_1499)" id="battery.100 F22 Fina">
...
function HasName15() {
  return (
    <div className="content-stretch flex flex-col items-start relative shrink-0" data-name="Has Name">
      <p className="font-['SF_Pro_Display:Regular',sans-serif] leading-[44.167px] not-italic relative shrink-0 text-[33.126px] text-center text-white whitespace-nowrap">Chrome</p>
    </div>
  );
}

function LogoAndText14() {
  return (
    <div className="content-stretch flex flex-col gap-[11.042px] items-center relative shrink-0 size-[176.67px]" data-name="Logo and Text">
      <Logo19 />
      <HasName15 />
...
function Iphone() {
  return (
    <div className="-translate-x-1/2 -translate-y-1/2 absolute blur-[0.504px] h-[2622px] left-[calc(50%+11.5px)] rounded-[203px] top-[calc(50%-1260px)] w-[1263px]" data-name="Iphone 18">
...
export default function IphoneBottom() {
  return (
    <div className="bg-white relative size-full" data-name="Iphone bottom">
      <Iphone />
    </div>
  );
}