import svgPaths from "./svg-kvs6nzinci";
...
function Iphone() {
  return (
    <div className="-translate-x-1/2 -translate-y-1/2 absolute blur-[0.504px] h-[2622px] left-[calc(50%+0.5px)] rounded-[203px] top-1/2 w-[1263px]" data-name="Iphone 18">
