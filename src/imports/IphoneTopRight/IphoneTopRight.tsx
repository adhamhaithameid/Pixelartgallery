import svgPaths from "./svg-zvv44iu5bl";
...
import imgLogo7 from "./83faf8fd8d2b291d7ca269bfcc66bc1320fdc2ef.png";
...
import imgLogo16 from "./488e42354456655c278d6a328e6ee463b222c634.png";
    ...
    <div className="absolute left-[300px] size-[40px] top-[35px]" data-name="Lens">
      <svg className="absolute block inset-0 size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 40 40">
        <g id="Lens">
          ...
          <g filter="url(#filter0_f_2_1520)" id="Ellipse 3">
            <ellipse cx="20.0009" cy="10.9091" fill="var(--fill-0, white)" fillOpacity="0.1" rx="9.09091" ry="3.63636" />
          </g>
          <g filter="url(#filter1_f_2_1520)" id="Ellipse 4">
            <ellipse cx="20.0009" cy="27.2727" fill="var(--fill-0, white)" fillOpacity="0.1" rx="9.09091" ry="5.45455" />
          </g>
        </g>
        <defs>
          <filter colorInterpolationFilters="sRGB" filterUnits="userSpaceOnUse" height="9.27273" id="filter0_f_2_1520" width="20.1818" x="9.91003" y="6.27274">
            <feFlood floodOpacity="0" result="BackgroundImageFix" />
            <feBlend in="SourceGraphic" in2="BackgroundImageFix" mode="normal" result="shape" />
            <feGaussianBlur result="effect1_foregroundBlur_2_1520" stdDeviation="0.5" />
          </filter>
          <filter colorInterpolationFilters="sRGB" filterUnits="userSpaceOnUse" height="12.9091" id="filter1_f_2_1520" width="20.1818" x="9.91003" y="20.8182">
            <feFlood floodOpacity="0" result="BackgroundImageFix" />
            <feBlend in="SourceGraphic" in2="BackgroundImageFix" mode="normal" result="shape" />
            <feGaussianBlur result="effect1_foregroundBlur_2_1520" stdDeviation="0.5" />
          </filter>
  ...
  return (
    <div className="absolute h-[38.106px] left-[5.52px] top-[11.04px] w-[52.763px]" data-name="wifi F17">
      <svg className="absolute block inset-0 size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 52.7633 38.106">
        <g clipPath="url(#clip0_2_1530)" id="wifi F17">
  ...
  return (
    <div className="absolute h-[38.522px] left-[8.28px] top-[11.04px] w-[85.154px]" data-name="battery.100 F22 Fina">
      <svg className="absolute block inset-0 size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 85.1543 38.5217">
        <g clipPath="url(#clip0_2_1545)" id="battery.100 F22 Fina">
...
function Logo19() {
  return (
    <div className="relative rounded-[38.647px] shrink-0 size-[176.67px]" data-name="Logo">
      <img alt="" className="absolute inset-0 max-w-none object-cover pointer-events-none rounded-[38.647px] size-full" src={imgLogo16} />
    </div>
  );
}
...
function Iphone() {
  return (
    <div className="-translate-x-1/2 -translate-y-1/2 absolute blur-[0.504px] h-[2622px] left-[calc(50%-692.5px)] rounded-[203px] top-[calc(50%+823px)] w-[1263px]" data-name="Iphone 18">
...
export default function IphoneTopRight() {
  return (
    <div className="bg-white relative size-full" data-name="Iphone top right">
      <Iphone />
    </div>
  );
}